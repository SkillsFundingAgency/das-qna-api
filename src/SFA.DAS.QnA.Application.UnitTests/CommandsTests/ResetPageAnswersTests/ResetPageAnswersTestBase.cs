...
namespace SFA.DAS.QnA.Application.UnitTests.CommandsTests.ResetPageAnswersTests
{
    ...
    public class ResetPageAnswersTestBase
    {
        ...
        public async Task SetUp()
        {
            ...
            Handler = new ResetPageAnswersHandler(DataContext, new NotRequiredProcessor(),new TagProcessingService(DataContext),Substitute.For<IApplicationAnswersRepository>(), Substitute.For<IWorkflowRepository>(), Substitute.For<IApplicationRepository>());
